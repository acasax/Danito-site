        ...
        <div className="ProductWindow">
            <div className="ProductWindow__container">
                ...
                <div className="ProductWindow__product">
                    ...
                    <div className="ProductWindow__ButtonsContainer">
                        <div className="ProductWindow__Buttons">
                            <button className={windowsPvc ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('windowsPvc')}>
                                {PRODUCTS.pvcProzori}
                            </button>
                            {windowsPvc
                              ? null
                ...
                <div className="ProductWindow__product">
                    ...
                    <div className="ProductWindow__ButtonsContainer">
                        <div className="ProductWindow__Buttons">
                            <button className={pvcDoors ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('doorsPvc')}>
                                {PRODUCTS.pvcVrata}
                            </button>
                            {pvcDoors
                              ? null
                        ...
                        <div className="ProductWindow__Buttons">
                            <button className={SafeDoors ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('safeDoors')}>
                ...
                <div className="ProductWindow__product">
                    ...
                    <div className="ProductWindow__ButtonsContainer">
                        <div className="ProductWindow__Buttons">
                            <button className={fundermax ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('fundermax')}>
                        ...
                        <div className="ProductWindow__Buttons">
                            <button className={glass ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('glass')}>
                        ...
                        <div className="ProductWindow__Buttons">
                            <button className={granit ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('granit')}>
                ...
                <div className="ProductWindow__product">
                    ...
                    <div className="ProductWindow__ButtonsContainer">
                        ...
                        <div className="ProductWindow__Buttons">
                            <button className={uskocno ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('uskocnoKlizni')}>
                        ...
                        <div className="ProductWindow__Buttons">
                            <button className={acordian ? 'buttonClose' : 'buttonOpen'}
                                    onClick={() => selectProduct('acordian')}>
